<?php
    ...
    interface IPage{
		...
		/** добавляем на страницу css-файл(-ы) для 4size */
        public function addCss4size($css);
    ...
    class Page implements IPage{
       ...
       private function __construct(){
        ...
        public function addCss($css){
		 ...
		 /** Добавляем файлы стилей на страницу c id - это нужно для 4size */
        public function addCss4size($css,$id=null){
            $args = func_get_args();
                $css = trim($css);
				if ($this -> _headerStart)
				{
					    if($id!=null)
					    {
					    	$this->_headerCss.="<link rel='stylesheet' id='{$id}' href='{$css}' type='text/css' media='{$this -> _cssMediaType}' />";
					    }
						else
						{
							$this->_headerCss.="<link rel='stylesheet' href='{$css}' type='text/css' media='{$this -> _cssMediaType}' />";
				...
				else
				{
					 if($id!=null)
					    {
							$this->_css.="<link rel='stylesheet' id='{$id}' href='{$css}' type='text/css' media='{$this -> _cssMediaType}' />";
						}
						else
						{
							$this->_css.="<link rel='stylesheet' href='{$css}' type='text/css' media='{$this -> _cssMediaType}' />";
        ...
        private function preparePage(){
			...
			$footer = ob_get_clean();
			if($_SERVER[SERVER_NAME]=='mg.dn.ua')
			{
				$new_index_meta='<meta name="robots" content="noindex,nofollow" />';
			}
			else
			{
				$new_index_meta='';
            ...
            $this -> _page = $this -> _doctype.
                              ...
                              <link rel='stylesheet' id='fsize' href='css/styles_1000.css' type='text/css' media='screen' />".
                              $this -> _headerCss.
                              $this -> _css.
                              $this -> _headerJs.
                              $this -> _js.
